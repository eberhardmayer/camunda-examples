...
/**
 * Copy of:
 * https://github.com/camunda/camunda-bpm-process-test-coverage/blob/master/test/src/test/java/process_test_coverage/spring/SpringProcessWithCoverageTest.java
 *
 */
@Configuration
public class InMemProcessEngineConfiguration {
	 ...
	 */
	@Bean
	public ServiceCall serviceCallMock() {
		return new ServiceCallMock();
	}
